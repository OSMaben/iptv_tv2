...
function Terms_Of_Service() {
  return (
    <div className=" text-white pt-20">
      <Info_Layout title={"Terms of Service"}>
          ...
          <div className=" w-full max-w-7xl px-5 lg:px-0 lg:text-lg py-16">
            <div className="inside-content">
              <p>
                ...
                and Services available at https://text.com website (the
                “Service”) operated by website (“us”, “we”, or “our”).
              </p>

              <p>
                Your access to our services is subject to your acceptance,
              ...
              <p>
                Please read the Agreement carefully before accessing or using
                ...
                part of the terms of the Agreement, then you may not access or
                use our Services.
              </p>

              <h3 className=" font-bold text-3xl pt-5 pb-3">
              ...
              <p>
                ...
                parties) solely with website and its licensors.
              </p>
              ...
              <p>
                ...
                products, software, embeds, or applications developed by a third
                party (“Third-Party Services”).
              </p>
              ...
              <ul>
                <li>
                  ...
                  shall not be responsible or liable to anyone for Third Party
              ...
              <h3 className=" font-bold text-3xl pt-5 pb-3">Accounts</h3>
              ...
              <p>
                ...
                services that are not owned or controlled by website.
              </p>

              <p>
                website assumes no responsibility for the content, privacy
                policies, or practices of any third party web sites or services.
                website shall also not be responsible or liable, directly or
              ...
              <p>
                We advise you to read the terms and conditions and privacy
                policies of any third-party web sites or services that you
                visit.
              </p>

              <h3 className=" font-bold text-3xl pt-5 pb-3">Termination</h3>
              ...
              <p>
                If you wish to terminate the Agreement or your website account,
              ...
              <h3 className=" font-bold text-3xl pt-5 pb-3">Disclaimer</h3>

              <p>
                Our Services are provided “AS IS.” and “AS AVAILABLE” basis.
                website and its suppliers and licensors hereby disclaim all
                warranties of any kind, express or implied, including, without
                limitation, the warranties of merchantability, fitness for a
                particular purpose and non-infringement. Neither website , nor
              ...
              <p>
                ...
                Agreement and any access to or use of our Services will be
                governed by the laws of New York.
              </p>

              <p>
                The proper venue for any disputes arising out of or relating to
                the Agreement and any access to or use of our Services will be
                the state and federal courts located in New York.
              </p>

              <h3 className=" font-bold text-3xl pt-5 pb-3">Changes</h3>

              <p>
                website reserves the right, at our sole discretion, to modify or
                replace these Terms at any time.
              </p>

              <p>
                If we make changes that are material, we will let you know by
                posting on our website, or by sending you an email or other
                communication before the changes take effect. The notice will
                designate a reasonable period of time after which the new terms
                will take effect.
              </p>
              ...
              <p>
                ...
                <br />
                30&nbsp;days notice prior to the effective changes. If you
                disagree with our changes, then you should stop using our
              ...
              <h3 className=" font-bold text-3xl pt-5 pb-3">Contact Us</h3>
